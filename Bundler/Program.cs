...
namespace Bundler
{
    class Program
    {
        ...
        public static void Main()
        {
            ...
            string version;
            version = GetVersion(RelPathToSolutionRootFolder + "Server/bin/Release/Server.exe");

            RootFolderInZip = "OurProject/"; //name of the folder created inside the zip file

            files.Add(RelPathToSolutionRootFolder + "Server/bin/Release/Server.exe");

            string outputFile = RelPathToSolutionRootFolder + "Server-" + version + ".zip"; //name of the output zip file
